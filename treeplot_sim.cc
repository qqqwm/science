...
void treeplot_sim() {
    ...
    */
    ...
    // *********    PLOT HISTOGRAMS AFTER after nHits cut
    cout << "HISTOGRAMS AFTER after nHits cut: " << hist_cos_x_cut->GetEntries() << endl;
    ...
    maxes = {hist_cos_x_cut->GetMaximum(), hist_cos_y_cut->GetMaximum(), hist_cos_z_cut->GetMaximum()};
    max_hist = 1.05 * (*max_element(maxes.begin(), maxes.end()));

    hist_cos_x_cut->SetMaximum(max_hist);
    hist_cos_x_cut->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_x_cut_sim.pdf");

    hist_cos_y_cut->SetMaximum(max_hist);
    hist_cos_y_cut->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_y_cut_sim.pdf");

    hist_cos_z_cut->SetMaximum(max_hist);
    hist_cos_z_cut->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_z_cut_sim.pdf");

    // *********    PLOT HISTOGRAMS AFTER after nHits cut
    cout << "HISTOGRAMS AFTER after nHits cut: " << hist_cos_x_cut1->GetEntries() << endl;
    ...
    maxes = {hist_cos_x_cut1->GetMaximum(), hist_cos_y_cut1->GetMaximum(), hist_cos_z_cut1->GetMaximum()};
    max_hist = 1.05 * (*max_element(maxes.begin(), maxes.end()));

    hist_cos_x_cut1->SetMaximum(max_hist);
    hist_cos_x_cut1->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_x_cut1_sim.pdf");

    hist_cos_y_cut1->SetMaximum(max_hist);
    hist_cos_y_cut1->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_y_cut1_sim.pdf");

    hist_cos_z_cut1->SetMaximum(max_hist);
    hist_cos_z_cut1->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_z_cut1_sim.pdf");
    // ****** PLOT HISTOGRAMS AFTER after #Delta_{Z} cut
    cout << "HISTOGRAMS AFTER after DeltaZ cut:  " << hist_cos_x_cut2->GetEntries() << endl;
    ...
    maxes = {hist_cos_x_cut2->GetMaximum(), hist_cos_y_cut2->GetMaximum(), hist_cos_z_cut2->GetMaximum()};
    max_hist = 1.05 * (*max_element(maxes.begin(), maxes.end()));

    hist_cos_x_cut2->SetMaximum(max_hist);
    hist_cos_x_cut2->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_x_cut2_sim.pdf");

    hist_cos_y_cut2->SetMaximum(max_hist);
    hist_cos_y_cut2->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_y_cut2_sim.pdf");

    hist_cos_z_cut2->SetMaximum(max_hist);
    hist_cos_z_cut2->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_z_cut2_sim.pdf");
    // ****************************************************************** PLOT HISTOGRAMS AFTER after #Delta_{Z} & nHits cut
    cout << "HISTOGRAMS AFTER after both cuts: " << hist_cos_x_cut3->GetEntries() << endl;
    ...
    maxes = {hist_cos_x_cut3->GetMaximum(), hist_cos_y_cut3->GetMaximum(), hist_cos_z_cut3->GetMaximum()};
    max_hist = 1.05 * (*max_element(maxes.begin(), maxes.end()));

    hist_cos_x_cut3->SetMaximum(max_hist);
    hist_cos_x_cut3->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_x_cut3_sim.pdf");

    hist_cos_y_cut3->SetMaximum(max_hist);
    hist_cos_y_cut3->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_y_cut3_sim.pdf");

    hist_cos_z_cut3->SetMaximum(max_hist);
    hist_cos_z_cut3->SetMinimum(0);
    ...
    c0->SaveAs("hist_cos_z_cut3_sim.pdf");
}